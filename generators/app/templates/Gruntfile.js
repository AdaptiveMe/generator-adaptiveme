...
module.exports = function (grunt) {
  ...
  open: {
    server: {
      url: 'http://localhost:' + SERVER_PORT + '/src'
    }
  }
  ,
  ...
  copy: {
    release: {
      files: [{expand: true, cwd: 'src', src: ['images/*.{png,gif,jpg,svg}', 'img/*.{png,gif,jpg,svg}', 'fonts/*', '*.html'], dest: 'dist/www'}]
    }
  ,
    config: {
  ...
  htmlmin: {
    dist: {
      options: {
        removeComments: true, collapseWhitespace
      :
        true
      }
    ,
